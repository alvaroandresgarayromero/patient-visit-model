...
# appserver.py is in this location to avoid
# using relative path for cli commands
# appserver.py is expected here
# by web/web.Dockerfile
# appserver.py is expected here
# by web/wait_for_db_container.sh

# Running the server via Gunicorn
# (dockerfile Gunicorn looks for this file)
gunicorn_app = create_app()

if __name__ == "__main__":
    # DockerFile will execute our own CLI
